...
After mastering these fundamentals, you’ll move into:
- ✅ Intermediate SQL: JOINs, Subqueries, Set Operations
- ✅ Excel: Functions, PivotTables, Dashboards
- ✅ Tableau / Power BI: Visualizing and presenting insights

---

## 📁 Suggested File Structure in GitHub
...
└── /week1_sql
    ...
    ├── day2_filtering.md
    ├── day3_order_limit.md
    ├── day4_distinct_groupby.md
    └── sql-cheat-sheet.md   <-- Save this file here
```

---

## 📄 How to Generate PDF from This Markdown

### Option 1: Use VS Code + Markdown PDF Extension
1. Install [Markdown PDF](https://marketplace.visualstudio.com/items?itemName=yzane.vscode-markdown-pdf)
2. Open this file in VS Code
3. Right-click → “Markdown PDF: Export (pdf)”

### Option 2: Online Converter
1. Copy the content above into a `.md` file or paste it at [https://www.markdowntopdf.com/](https://www.markdowntopdf.com/)
2. Click "Convert" and download your PDF
